package com.indiewalkabout.cosmoraiders.domain.model.player

import androidx.compose.ui.geometry.Offset
import com.indiewalkabout.cosmoraiders.data.local.PLAYER_LIVES
...
class Player {
    ...
    fun reset() {
        lives = PLAYER_LIVES
        position = Offset.Companion.Zero
